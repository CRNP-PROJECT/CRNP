...
<div class="about-container">
    <div class="about-card main-reveal">
        ...
        <p class="about-subtitle">Your trusted partner for events and celebrations.</p>
        <div class="kpi-grid">
        ...
        <div class="about-content-section">
            ...
            <h2 class="section-title"><i class="fa-solid fa-star"></i> Curated Essentials</h2>
            <p>We provide quality rental equipment for your special occasions including tables,
                chairs, and skirting cloths. Our commitment is to make your events memorable and hassle-free.</p>
        </div>
        <div class="about-content-section">
            <h2 class="section-title"><i class="fa-solid fa-envelope-open-text"></i> Let's Connect</h2>
            <p>For inquiries and reservations, please don't hesitate to reach out. We're here to help
                you plan the perfect event.</p>
        </div>
        <div class="about-content-section">
            <h2 class="section-title"><i class="fa-solid fa-map-location-dot"></i> Visit Our Location</h2>
            <p>Mabolo, Iloilo City Proper, Iloilo City, Philippines.</p>
            <div class="map-wrapper">
                <iframe 
                    src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3920.312384742461!2d122.56943647585094!3d10.710383359659346!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x33aee9420cb57e6f%3A0x34d50605ea28e930!2sCrates%20N&#39;%20Plates%20Diner!5e0!3m2!1sen!2sph!4v1712950000000!5m2!1sen!2sph" 
