              ...
              <table class="tbl">
                ...
                <tbody>
                  <?php foreach ($orders as $id => $o):
                    ...
                    $placed  = self::fmt_time($o['created_at'] ?? null);
                ...
                <tbody>
                  ...
                  ?>
                    <tr>
                      ...
                      <td class="muted"><?= e(self::fmt_time($b['appointment_time'] ?? null)) ?></td>
                      <td class="muted"><?= e(self::fmt_time($b['return_time'] ?? null)) ?></td>
