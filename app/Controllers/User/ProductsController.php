...
/**
 * ProductsController — Customer shop.
...
class ProductsController {
            ...
            <div class="shop-toolbar">
              ...
              <div class="shop-cats" id="prodCats">
                ...
                <button class="shop-cat" data-cat="<?= e($c) ?>">
                  <svg class="shop-cat__icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"><?= self::shop_cat_icon($c) ?></svg>
                  <span><?= e($c) ?></span>
                </button>
                <?php endforeach; ?>
              </div>
    ...
    private static function shop_cat_icon(string $cat): string {
        $icons = [
