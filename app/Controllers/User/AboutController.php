...
/**
 * AboutController — public About Us page.
...
class AboutController {
    ...
    public static function render(): void {
        ...
        <style>
          ...
          .about-hero h1{color:#fff;max-width:20ch;font-family:var(--serif);font-weight:700;letter-spacing:-.01em;}
          ...
          .about-stat__num{font-family:var(--sans);font-size:1.6rem;font-weight:700;color:var(--ink);line-height:1;position:relative;z-index:1;}
        ...
        <div class="card card--pad-lg">
          <div class="card__head"><h3 style="font-size:1.3rem;">Let's Connect</h3></div>
              ...
              <div class="col" style="gap:20px;">
                ...
                <div class="contact-item">
                  ...
                  <div>
                    ...
                    <div class="contact-item__value"><?= e($s['hours']) ?></div>
                  </div>
                </div>
                <div class="contact-item">
                  ...
                  <div>
                    ...
                    <div class="contact-item__value"><?= e($s['phone']) ?><br><small class="muted">Call us for reservations and inquiries.</small></div>
                  </div>
                </div>
              </div>
