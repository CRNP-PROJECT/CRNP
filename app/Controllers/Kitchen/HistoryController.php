...
/**
 * HistoryController — Read-only archive of completed (done) orders.
...
class HistoryController {
              ...
              <tbody>
                <?php foreach ($done as $id => $o): ?>
                  ...
                  <tr>
                    ...
                    <td><?= e($o['done_by'] ?? '') ?></td>
                    <td class="muted"><?= e(self::formatTs((string)($o['done_at'] ?? $o['updated_at'] ?? ''))) ?></td>
    ...
    private static function formatTs(?string $ts): string {
