...
/**
 * DashboardController — Dashboard: KPI strip, 7-day sales chart, recent activity.
 *
...
class DashboardController {
          ...
          <div class="grid--pie">
            <div class="card chart-card">
              ...
              <div class="card__body">
                ...
                <?php else: ?>
                  <div class="pie-wrap">
                    <?= self::svgPie($categorySales, $pieColors) ?>
                    <ul class="pie-legend">
              ...
              <div class="card__body">
                ...
                <?php else: ?>
                  <div class="pie-wrap">
                    ...
                    ?>
                    <?= self::svgPie($paymentMethods, $pieColors, 180, $pmColors) ?>
                    <ul class="pie-legend">
          ...
          <div class="grid--pie">
            <div class="card chart-card">
              ...
              <div class="card__body">
                ...
                <?php else: ?>
                  <div class="pie-wrap">
                    <?= self::svgPie($orderStatuses, $pieColors, 180, $orderStatusColors) ?>
                    <ul class="pie-legend">
    ...
    private static function svgPie(array $data, array $pieColors, int $size = 180, array $customColors = []): string {
