...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($action === 'save') {
        ...
        try {
            ...
            $filename = save_upload('image', __DIR__ . '/../assets/img/products');
            if ($filename !== null) {
                $data['image'] = $filename;
            }
    ...
    <div class="table-wrap" style="border:0;border-radius:0;">
      <table class="tbl">
        ...
        <?php else: foreach ($products as $pid => $p):
            ...
            $img = $p['image'] ? '/assets/img/products/' . rawurlencode($p['image']) : '/assets/img/placeholder.svg';
        ?>
          <tr>
            <td>
              <div class="img-row">
        ...
        <div class="field">
          ...
          <div class="img-row">
            <img id="image-preview" class="img-preview"
                 src="<?= $formImage ? e('/assets/img/products/' . rawurlencode($formImage)) : e('/assets/img/placeholder.svg') ?>"
                 alt="Preview">
            <div>
