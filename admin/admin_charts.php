this is mt admin charts .php <?php
...
foreach ($bookings as $b) {
    ...
    // optional filter (remove if not needed)
    if ($status !== "accepted") continue;
